    ...
    private class ClickListener extends MouseAdapter {
        public void mousePressed(MouseEvent e) {
            ...
            if (types.size() < 1100) {
                ...
                // and replace the "CustomPokemon1" and "CustomPokemon2"
                // with your actual species names. You should change both
                // the Strings and the class names used to create new
                // Pokemon on lines 179 and 181 to match the names of
                // your custom Pokemon classes. Don't forget to delete
                // the todo to fix checkstyle!
                ...
                } else if (pokemonSpecies.equals("Meowth")) {
                    types.add(new Meowth(p.x, p.y, bounds));
                } else if (pokemonSpecies.equals("Exeggcute")) {
                    types.add(new Exeggcute(p.x, p.y, bounds));
                }
            }
