...
public class ControlPanel extends JPanel {
    ...
    public ControlPanel() {
        ...
        add(torterra);
        custom1 = new JButton("Meowth");
        custom1.addActionListener(new ButtonListener("Meowth"));
        add(custom1);

        custom2 = new JButton("Exeggcute");
        custom2.addActionListener(new ButtonListener("Exeggcute"));
        add(custom2);
